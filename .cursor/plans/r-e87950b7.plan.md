---
name: Implement AM/PM checkboxes for RDS schedule and Ad Inserter hours
overview: ""
todos:
  - id: 4eaec1ba-5e7f-4515-95f2-36d503da2611
    content: Add AM/PM 24-hour checkbox grid for RDS schedule in ui_config_window.py
    status: pending
  - id: 4d17a8da-0e59-42ef-80ed-64b847540196
    content: Add single-toggle buttons for Select/Clear All Days and Hours in RDS editor
    status: pending
  - id: cfdc130c-abdd-4165-a2d4-aded8dbce1a2
    content: Update RDS save/load to read/write checkbox-selected hours to Scheduled.Times
    status: pending
  - id: c0757ff0-f3ea-468a-aaf9-175b0a16d17d
    content: Render RDS Times column in AM/PM in tree and updates
    status: pending
  - id: 1864db02-79b7-4c73-9c67-6d65843fbc65
    content: Remove hours text entry and example label from RDS UI
    status: pending
  - id: bd6cc42b-7f69-48b0-8a03-b772a7e90900
    content: Update Ad Inserter hour checkbox labels to AM/PM
    status: pending
  - id: faf307a4-b700-4612-bc9a-eef9801448a9
    content: Add Select/Clear All Days toggle in Ad Inserter
    status: pending
  - id: 0ec765d5-9097-4b3c-98c5-e3f63f83fd3e
    content: Replace Select All Hours with single-toggle in Ad Inserter
    status: pending
---
